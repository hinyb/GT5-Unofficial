...
public abstract class MTEMultiblockECBase extends MTEMultiBlockBase implements IECMultiblock {
    ...
    public MTEMultiblockECBase(int aID, String aName, String aNameRegional) {
        ...
        addComponent(new StandardMaintenanceLogicComponent());
    ...
    public <T extends IComponent> void addComponent(@NotNull T component) {
        ...
        for (var inter : interfaces)
        {
            ...
            {
                components.computeIfAbsent((Class<? extends IComponent>) inter, k -> new ArrayList<>()).add(component);
            }
        }
    ...
    */
    ...
    public void saveNBTData(NBTTagCompound aNBT) {
        ...
        for (var component : getComponents(ISaveableComponent.class))
        {
    ...
    public void checkMaintenance() {
        ...
        if (getRepairStatus() != getIdealStatus()) {
            for (MTEHatchMaintenance tHatch : getComponent(IMaintenanceLogicComponent.class).getValidHatches()) {
    ...
    public void onDisableWorking() {
        MTEHatchDroneDownLink ddl = getComponent(IMaintenanceLogicComponent.class).tryGetDroneDownLink();
        if (ddl != null) {
    ...
    private static boolean hasExactlyOne(Iterable<?> iterable)
    {
    ...
    protected CheckRecipeResult doCheckRecipe() {
        ...
        for (IDualInputHatch dualInputHatch : getComponent(IDualInputLogicComponent.class).getValidHatches()) {
        ...
        for (byte color = 0; color < (doColorChecking ? 16 : 1); color++) {
            ...
            if (isInputSeparationEnabled()) {
                var it = getComponent(IItemInputLogicComponent.class).getValidHatches().iterator();
                if (it.hasNext()) {
    ...
    private short getHatchColors() {
        ...
        for (var bus : getComponent(IItemInputLogicComponent.class).getValidHatches()) hatchColors |= (short) (1 << bus.getColor());
        for (var hatch : getComponent(IFluidInputLogicComponent.class).getValidHatches()) hatchColors |= (short) (1 << hatch.getColor());
    ...
    public boolean depleteInput(ItemStack aStack, boolean simulate) {
        for (IFluidInputLogicComponent component : getComponents(IFluidInputLogicComponent.class)) {
    ...
    public void addIfSmartInput(IMetaTileEntity mte) {
        getComponent(ISmartHatchLogicComponent.class).tryAttachHatch(mte);
    }
    ...
    public boolean addMaintenanceToMachineList(IGregTechTileEntity aTileEntity, int aBaseCasingIndex) {
        ...
        if (aMetaTileEntity == null) return false;
        updateTexture(aMetaTileEntity, aBaseCasingIndex);
        return getComponent(IDualInputLogicComponent.class).tryAttachHatch(aMetaTileEntity);
    }
    ...
    public boolean addEnergyInputToMachineList(IGregTechTileEntity aTileEntity, int aBaseCasingIndex) {
        ...
        if (aMetaTileEntity == null) return false;
        updateTexture(aMetaTileEntity, aBaseCasingIndex);
        return getComponent(IMultiblockEnergyInputLogicComponent.class).addEnergyHatch(aMetaTileEntity);
    }
    ...
    public boolean addMultiAmpEnergyInputToMachineList(IGregTechTileEntity aTileEntity, int aBaseCasingIndex) {
        ...
        return comp.addMultiAmpEnergyInput(aMetaTileEntity);
    }
    ...
    public boolean addExoticEnergyInputToMachineList(IGregTechTileEntity aTileEntity, int aBaseCasingIndex) {
        ...
        updateTexture(aMetaTileEntity, aBaseCasingIndex);
        var comp = getComponent(StandardEnergyInputLogicComponent.class);
        return comp.addExoticEnergyInput(aMetaTileEntity);
    }
    ...
    public boolean addDynamoToMachineList(IGregTechTileEntity aTileEntity, int aBaseCasingIndex) {
        ...
        return comp.addNormalDynamo(aMetaTileEntity);
    }
    ...
    public boolean addExoticDynamoToMachineList(IGregTechTileEntity aTileEntity, int aBaseCasingIndex) {
        ...
        updateTexture(aMetaTileEntity, aBaseCasingIndex);
        var comp = getComponent(StandardEnergyOutputLogicComponent.class);
        return comp.addExoticDynamo(aMetaTileEntity);
    }
    ...
    public boolean addLaserSourceToMachineList(IGregTechTileEntity aTileEntity, int aBaseCasingIndex) {
        ...
        updateTexture(aMetaTileEntity, aBaseCasingIndex);
        var comp = getComponent(StandardEnergyOutputLogicComponent.class);
        return comp.addLaserSource(aMetaTileEntity);
    }
    ...
    public boolean addMufflerToMachineList(IGregTechTileEntity aTileEntity, int aBaseCasingIndex) {
        ...
        if (aMetaTileEntity == null) return false;
        updateTexture(aMetaTileEntity, aBaseCasingIndex);
        return getComponent(IMultiblockPollutionLogicComponent.class).tryAttachHatch(aMetaTileEntity);
    }
    ...
    public boolean addInputHatchToMachineList(IGregTechTileEntity aTileEntity, int aBaseCasingIndex) {
        ...
        if (aMetaTileEntity instanceof MTEHatchInput hatch) {
            return getComponent(IMultiblockFluidInputLogicComponent.class).tryAttachHatch(aMetaTileEntity);
        }
        return false;
    }
